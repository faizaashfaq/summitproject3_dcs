        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li class="active">
                        <a href="capex.php"><i class="fa fa-fw fa-newspaper-o"></i> Capex</a>
                    </li>
					<li>
                        <a href="opex.php"><i class="fa fa-fw fa-newspaper-o"></i> Opex</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
            ...
            <div class="container-fluid">
				...
				<form class="form-inline" action="upload.php" method="post" enctype="multipart/form-data">
								  ...
								  <div class="form-group" >
									<input type="text" class="form-control" name="costname" id="costname" placeholder="Name" required>
								  </div>
                                ...
                                <select class="form-control" name="cost">
                                    <option value="Commercial Data Center Karachi">Opex</option>
                                    <option value="IT Data Center Karachi">Capex</option>
                                 
                                </select>
                            </div>
							
								<div class="form-group" >
									<input type="text" class="form-control" name="amount" id="amount" placeholder="Amount in Rs/-" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required>
								</div>
                            ...
                            <table class="table table-bordered table-hover table-striped" id="requests">
                                ...
                                <tbody id="tablebody">
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM documents WHERE dc='".$DC."'";
											...
											if($result->num_rows > 0 ){
												while($row = $result->fetch_assoc()){ ?>
														<tr>
															...
															<form class="form-inline" action="comment.php" method="post" enctype="multipart/form-data">
																		  <div class="form-group" >
															...
															<button type='submit' name='comment' class='btn btn-default btn-sm' onclick="comment(<?php echo $row["id"] ?>)" >Add</button>
															<?php }else{
...
<script>
	...
	// Remove row
			function comment(id) {
					...
					$.post('comment.php',{postid:id, postcomment:comment}, function(data){
						alert("Request Accepted");
						
					});
				
				$( "#requests" ).load( "dcdocuments.php #requests" );
			}
		</script>
