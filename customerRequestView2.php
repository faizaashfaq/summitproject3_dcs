...
<body>
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sql = "UPDATE placement SET status= 'Awaiting approval from DC' WHERE id = '".$_POST["id"]."' ";
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        echo("Connection Successful");
                                        $sql = "SELECT id, clientid, requestfor, requestdate, requesttime, name, nic, company, timein, timeout, manufacturer, equipmentname, power, serialno, rack, status FROM placement WHERE id = ".$ID."";
                                            ...
                                            while($row = $result->fetch_assoc()){
                                             ?>
													...
													<th>Request ID:</th>
														...
														<td><?php echo $row["equipmentname"] ?></td></tr>
														<tr>

														<th>Serial No:</th>
                                                                        
														<td><?php echo $row["serialno"] ?></td></tr>
														<tr>
														<th>Power Rating:</th>                                        
														<td><?php echo $row["power"] ?></td></tr>
														<tr>

														<th>Rack to be placed into:</th>
                                                                         
														<td><?php echo $row["rack"] ?></td></tr>
														<tr>
														<th>Status:</th>
