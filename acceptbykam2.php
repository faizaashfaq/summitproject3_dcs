<?php
        ...
        $sql = "UPDATE placement SET status= 'Awaiting approval from DC' WHERE id = '".$id."' ";
        $conn->query($sql);
		...
		//Mail function
			...
			$kammsg="Placement request is approved , ID=".$id.". Request is now sent to DC for approval. Please visit the portal for details";
			echo $kammsg;
			mail($kamemail, "Request appoved".$id, $kammsg,  "From: ptcldatacenters@ptcl.net.pk");
			
			$clientmsg="Your placement request is apporved by KAM and is sent DC for approval. , ID=".$id.". Please visit the portal for details";
			echo $clientmsg;
