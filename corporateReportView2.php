                            ...
                            <table class="table table-bordered table-hover table-striped" id="requests">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT id, requestfor, requestdate, requesttime, name, nic, company, timein, timeout, manufacturer, equipmentname, power, serialno, rack, status FROM placement WHERE id = ".$ID." LIMIT 10";
                                             ...
                                             ?>
                                                    <tr>
													 <th>Request ID:</th>
														...
														<tr>
														<th>Rack to be installed into:</th>
