                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody id="tablebody">
                                    <?php
                                        ...
                                        $sql = "SELECT id, requestfor, requestdate, requesttime, status FROM placement WHERE KAM='".$_SESSION['user']."'LIMIT 10";
											...
											if($result->num_rows > 0 ){
												while($row = $result->fetch_assoc()){ ?>
														<tr>
                                                            ...
                                                            <td><a class="btn btn-default btn-sm" href="corporateReportView2.php?id=<?php echo $row['id'];?>">View</a></td>
														</tr>
												<?php
												}
											}
