...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        ";
		 ...
		 //Mail function
            $sql = "SELECT id,KAM FROM corrective where clientid='".$clientid."' ORDER BY id DESC LIMIT 1";
			...
			$kammsg="You've new maintenance request. ID=".$id.". Please Visit Portal for further details";
			mail($kamemail, "New maintanence request", $kammsg, "From: ptcldatacenters@ptcl.net.pk");
			...
			$msg="Maintanence request added succesfully, ID=".$id." Please Visit the portal to view the details";
			echo $msg;
