...
<body>
                                        ...
                                        if($result->num_rows > 0){
                                            while($row = $result->fetch_assoc()){ ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row["requesttime"] ?></td>
                                                        <td><?php echo $row["status"] ?></td>
                                                        <td><a class="btn btn-default btn-sm" href="customerRequestView2.php?id=<?php echo $row['id'];?>">View</a></td>
														<td><a href="javascript:removeRow(' <?php echo $row["id"] ?> ');" class="btn btn-default btn-sm">Delete</a></td>
                                                    </tr>
                                            <?php
                                            }
	...
	// Remove row
			function removeRow(id) {
				...
				$.post('delete.php',{postid:id}, function(data){
					...
					$( "#requests" ).load( "customerDashboard3.php #requests" );
				});
	...
	// Remove row
			function removeRow1(id) {
				...
				$.post('delete1.php',{postid:id}, function(data){
					
					$( "#requests1" ).load( "customerDashboard3.php #requests1" );
				});
